  ...
  if (platform === 'darwin') {
    if (!hasCommand('brew')) {
      return {
        ...
        cmd: null,
        args: null,
        description: 'Goose install requires Homebrew. Install brew (https://brew.sh) and re-run, or install Goose manually: brew install block-goose-cli.',
      }
    }
    return {
      available: true,
      cmd: 'brew',
      args: ['install', 'block-goose-cli'],
      description: 'brew install block-goose-cli',
    }
  }
